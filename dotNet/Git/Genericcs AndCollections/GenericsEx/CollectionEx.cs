...
namespace GenericsEx
{
    internal class CollectionEx
    {
        ...
        static void Main4() { 
            ...
            objListEmp.Add(new Employee { EmpNo = 1 , Name="Pooja"}) ;
            objListEmp.Add(new Employee { EmpNo = 2, Name = "Prasad" });
        ...
        static void Main() {
            ...
            objSortedList.Add(1, new Employee { EmpNo = 1, Name = "Pooja" });
            objSortedList.Add(2, new Employee { EmpNo = 2, Name = "Pragati" });


            foreach (KeyValuePair<int, Employee> item in objSortedList) {
               // Console.WriteLine(item.Key);  // EmpNo
                Console.Write(item.Value.EmpNo +" ");
